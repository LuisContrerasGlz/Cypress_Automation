describe('Home de freeRangeTesters', () => {
    ...
    cy.wait(2000)
      ...
      cy.get('#page_section_65262341 > div > section > div.sc-dntaoT.jyoYKi > div > div:nth-child(3) > section > div.sc-Rjrgp.hrskxD > div > div.sc-UblHX.cCHmJD > div > div > a').should('exist'); 
      //.should(not.exist)
      //.should(be.checked)
